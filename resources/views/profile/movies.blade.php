...
@section('title', 'Películas de ' . $user->name . ' | Larabook')
...
<style>
    ...
    .media-poster { width: 80px; height: 100%; object-fit: cover; }
            ...
            <div class="max-w-[851px] mx-auto relative">
                ...
                <div class="h-[43px] bg-white flex items-center justify-between pl-[180px]">
                    <div class="flex h-full">
                        ...
                        <div class="profile-nav-item active border-b-2 border-[#385898] text-[#4b4f56]">Películas</div>
                    </div>
        ...
        <div class="max-w-[851px] mx-auto mt-4 pb-20">
            <div class="bg-white border border-[#dddfe2] rounded-sm min-h-[400px]">
                <div class="p-4 border-b border-[#e5e5e5] flex justify-between items-center">
                    <h2 class="text-[20px] font-bold text-[#1c1e21] flex items-center gap-2"><span class="text-gray-500">🎬</span> Películas</h2>
                    @if(Auth::id() === $user->id) <button class="text-[#1877f2] text-sm font-semibold hover:bg-blue-50 px-3 py-1 rounded">+ Agregar películas</button> @endif
                </div>
                <div class="p-4">
                    <div class="media-grid">
                        @foreach(['The Social Network', 'Inception', 'Transformers: G1', 'Blade Runner 2049'] as $movie)
                        <div class="media-card">
                            <div class="media-poster bg-gray-200 flex items-center justify-center text-gray-400 text-xs text-center p-1">
                                Poster de {{ $movie }}
                            </div>
                            <div class="media-info">
                                <a href="#" class="media-title">{{ $movie }}</a>
                                <div class="media-meta">Película · Vista</div>
                            </div>
