...
@section('title', 'Música de ' . $user->name . ' | Larabook')
...
<style>
    ...
    .interest-card { display: flex; align-items: center; background: white; border: 1px solid #e9ebee; border-radius: 3px; overflow: hidden; }
            ...
            <div class="max-w-[851px] mx-auto relative">
                ...
                <div class="h-[43px] bg-white flex items-center justify-between pl-[180px]">
                    <div class="flex h-full">
                        ...
                        <div class="profile-nav-item active border-b-2 border-[#385898] text-[#4b4f56]">Música</div>
                    </div>
        ...
        <div class="max-w-[851px] mx-auto mt-4 pb-20">
            <div class="bg-white border border-[#dddfe2] rounded-sm min-h-[400px]">
                <div class="p-4 border-b border-[#e5e5e5] flex justify-between items-center">
                    <h2 class="text-[20px] font-bold text-[#1c1e21] flex items-center gap-2"><span class="text-gray-500">🎵</span> Música</h2>
                    @if(Auth::id() === $user->id) <button class="text-[#1877f2] text-sm font-semibold hover:bg-blue-50 px-3 py-1 rounded">+ Agregar artistas</button> @endif
                </div>
                <div class="p-4">
                    <div class="interest-grid">
                        @foreach(['Daft Punk', 'The Weeknd', 'Taylor Swift', 'Metallica'] as $artist)
                        <div class="interest-card">
                            <img src="https://ui-avatars.com/api/?name={{ urlencode($artist) }}&background=random&size=100" class="interest-img">
                            <div class="interest-info">
                                <a href="#" class="interest-title">{{ $artist }}</a>
                                <div class="interest-meta">Músico/Banda · {{ rand(1, 100) }} M oyentes</div>
                            </div>
