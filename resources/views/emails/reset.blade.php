...
<head>
    ...
    <style>
        ...
        .button { display: inline-block; background-color: #4267b2; border: 1px solid #29487d; color: #ffffff; font-weight: bold; text-decoration: none; padding: 10px 20px; border-radius: 2px; margin-top: 15px; font-size: 14px; }
...
<body>
    <div class="wrapper">
        <table class="container" cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td class="content">
                    <p style="font-weight: bold; font-size: 16px; margin-top: 0;">Hola, {{ $countName }}.</p>
                    
                    <p>Recibimos una solicitud para restablecer tu contraseña de Larabook.</p>
                    
                    <p>Haz clic en el siguiente botón para cambiarla:</p>
                    
                    <a href="{{ $actionUrl }}" class="button">Cambiar contraseña</a>
            ...
            <tr>
                <td class="footer">
                    Este mensaje fue enviado a <a href="#">{{ $email }}</a>.<br>
